...
==========================================================
Ciktilar:
  - results/mu_pool_CA4.xlsx         (152 site x 17 mahalle)
  - results/mahalle_centroids_CA4.xlsx
  - results/mu_mevcut_zero_CA4.xlsx  (placeholder, 12 satir, hepsi 0)
"""
import math
import unicodedata
import numpy as np
...
if __name__ == "__main__":
    ...
    pool = pd.read_excel(RES / "pool_152_CA4.xlsx")
    ...
    df_cent.to_excel(RES / "mahalle_centroids_CA4.xlsx", index=False)
    print(f"[OK] mahalle_centroids_CA4.xlsx")
    ...
    mu_pool.to_excel(RES / "mu_pool_CA4.xlsx", index=False)
    print(f"[OK] mu_pool_CA4.xlsx  shape={mu_pool.shape}")
    ...
    df_zero.to_excel(RES / "mu_mevcut_zero_CA4.xlsx", index=False)
    print(f"[OK] mu_mevcut_zero_CA4.xlsx  (12 mevcut = 0, artik sabit degil)")
