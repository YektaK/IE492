...
CA3 = Path("D:/IE492/cozum_alternatifi_3_full_reloc_sb_yk/scripts")
...
if __name__ == "__main__":
    print("=" * 70)
    print("CA3 - Full Relocation (SB+YK) - End-to-End Pipeline")
    print("=" * 70)
    for step in STEPS:
        print(f"\n>>> Running {step} ...")
        result = subprocess.run([sys.executable, str(CA3 / step)],
