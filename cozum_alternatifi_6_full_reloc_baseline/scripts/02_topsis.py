...
==========================================================
Ciktilar:
  - results/criteria_matrix_CA6.xlsx
  - results/ahp_weights_CA6.xlsx
  - results/topsis_sonuclar_CA6.xlsx
"""
import math
import unicodedata
import numpy as np
...
df.to_excel(RES / "criteria_matrix_CA6.xlsx", index=False)
print(f"[OK] criteria_matrix_CA6.xlsx  rows={len(df)}")
...
df_ahp.to_excel(RES / "ahp_weights_CA6.xlsx", index=False)
print(f"[OK] ahp_weights_CA6.xlsx")
...
for sc in ahp_results:
    ...
    out[col] = cc
out.to_excel(RES / "topsis_sonuclar_CA6.xlsx", index=False)
print(f"[OK] topsis_sonuclar_CA6.xlsx")
print()
