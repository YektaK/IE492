# -*- coding: utf-8 -*-
"""
01_prep_full_relocation_CA6.py
==========================================================
...
==========================================================
Ciktilar:
  - data/mahalle_data_CA6.xlsx      (17 mahalle x P_road + barinma_ihtiyaci)
  - results/p_road_open_by_mahalle_CA6.xlsx
  - results/pool_152_CA6.xlsx        (140 aday + 12 mevcut, birlestirilmis)
"""
...
mahalle_data[out_cols].to_excel(DATA / "mahalle_data_CA6.xlsx", index=False)
print(f"[OK] {DATA / 'mahalle_data_CA6.xlsx'}")
...
p_summary.to_excel(RES / "p_road_open_by_mahalle_CA6.xlsx", index=False)
print(f"[OK] {RES / 'p_road_open_by_mahalle_CA6.xlsx'}")
...
pool.to_excel(RES / "pool_152_CA6.xlsx", index=False)
print(f"[OK] pool_152_CA6.xlsx  shape={pool.shape}")

print()
print("=" * 70)
print("CA6 - Tam Yer Degisikligi (20 konteyner) - Veri Ozeti")
print("=" * 70)
