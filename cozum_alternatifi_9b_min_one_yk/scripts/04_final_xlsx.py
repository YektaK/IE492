"""
04_final_xlsx.py - CA9b 18-sayfa konsolide xlsx
"""
import os
import pandas as pd
...
OUT = os.path.join(FINAL_DIR, "Sultanbeyli_Final_Results_CA9b.xlsx")
...
with pd.ExcelWriter(OUT, engine="openpyxl") as w:
    pd.DataFrame({
        ...
        "value": ["CA9b (min 1 + yol kapanma P_access - SPATIAL)",
    ...
    pd.read_excel(os.path.join(ROOT, CA, "comparison", "CA9b_vs_baseline.xlsx")).to_excel(
