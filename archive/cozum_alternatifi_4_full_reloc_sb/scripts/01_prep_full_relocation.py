# -*- coding: utf-8 -*-
"""
01_prep_full_relocation_CA4.py
==========================================================
...
==========================================================
Ciktilar:
  - data/mahalle_data_CA4.xlsx      (17 mahalle x P_road + barinma_ihtiyaci)
  - results/p_road_open_by_mahalle_CA4.xlsx
  - results/pool_152_CA4.xlsx        (140 aday + 12 mevcut, birlestirilmis)
"""
...
mahalle_data[out_cols].to_excel(DATA / "mahalle_data_CA4.xlsx", index=False)
print(f"[OK] {DATA / 'mahalle_data_CA4.xlsx'}")
...
p_summary.to_excel(RES / "p_road_open_by_mahalle_CA4.xlsx", index=False)
print(f"[OK] {RES / 'p_road_open_by_mahalle_CA4.xlsx'}")
...
pool.to_excel(RES / "pool_152_CA4.xlsx", index=False)
print(f"[OK] pool_152_CA4.xlsx  shape={pool.shape}")

print()
print("=" * 70)
print("CA4 - Tam Yer Degisikligi (20 konteyner) - Veri Ozeti")
print("=" * 70)
