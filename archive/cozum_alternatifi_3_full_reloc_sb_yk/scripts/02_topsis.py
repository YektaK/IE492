...
==========================================================
Ciktilar:
  - results/criteria_matrix_CA3.xlsx
  - results/ahp_weights_CA3.xlsx
  - results/topsis_sonuclar_CA3.xlsx
"""
import math
import unicodedata
import numpy as np
...
for _, r in pool.iterrows():
    ...
    for mlat, mlon in mev_for_gap:
        ...
        if d < min_d:
            min_d = d
    c3 = min_d
    # CA3: C4 = IBB Tablo 5-4 barinma ihtiyaci (hane)
...
df.to_excel(RES / "criteria_matrix_CA3.xlsx", index=False)
print(f"[OK] criteria_matrix_CA3.xlsx  rows={len(df)}")
...
df_ahp.to_excel(RES / "ahp_weights_CA3.xlsx", index=False)
print(f"[OK] ahp_weights_CA3.xlsx")
...
for sc in ahp_results:
    ...
    out[col] = cc
out.to_excel(RES / "topsis_sonuclar_CA3.xlsx", index=False)
print(f"[OK] topsis_sonuclar_CA3.xlsx")
print()
