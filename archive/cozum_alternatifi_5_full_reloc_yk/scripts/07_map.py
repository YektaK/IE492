...
if __name__ == "__main__":
    print("=" * 60)
    print("STEP 7: CA5 Secim Haritasi")
    print("=" * 60)

    sel = pd.read_excel(RES / "selection_Baseline_hard_CA5.xlsx", sheet_name="Selected_20")
    centroids = pd.read_excel(RES / "mahalle_centroids_CA5.xlsx")
    ...
    ax.set_ylabel("Enlem")
    ax.set_title("CA5 - Tam Yer Degisikligi (YK only, 20 konteyner)", fontsize=13, fontweight="bold")
    ax.grid(alpha=0.3)
    plt.tight_layout()
    out = MAPS / "CA5_selection_map.png"
